...
internal fun defaultAndroidSoundEffectPlayer(context: Context): AndroidSoundEffectPlayer =
    SoundPoolAndroidSoundEffectPlayer(
...
private const val SOUND_EFFECT_VOLUME = 0.45f

private class SoundPoolAndroidSoundEffectPlayer(
    context: Context,
